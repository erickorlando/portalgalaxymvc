        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NroDocumento = table.Column<string>(type: "varchar(11)", unicode: false, maxLength: 11, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        ...
                        .Annotation("SqlServer:TemporalHistoryTableName", "TallerHistory")
            ...
            migrationBuilder.InsertData(
                table: "Categoria",
                columns: new[] { "Id", "Estado", "FechaCreacion", "FechaModificacion", "Nombre" },
                values: new object[,]
                {
                    { 1, true, new DateTime(2023, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, ".NET" },
                    { 2, true, new DateTime(2023, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Java" },
                    { 3, true, new DateTime(2023, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "AWS" },
                    { 4, true, new DateTime(2023, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Azure" },
                    { 5, true, new DateTime(2023, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Python" }
                });
